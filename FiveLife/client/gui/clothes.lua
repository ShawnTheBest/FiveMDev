...
function drawMenuText(x,y ,width,height,scale, text, r,g,b,a)
    SetTextFont(0)
...
function ClothShop()
	...
	drawMenuText(0.177, 0.066, 0.25, 0.03, 0.40,"Cloth`n`Prop",255,255,255,255) -- header
	...
	if cmenu.show == 1 then
		...
		drawMenuText(0.177, 0.128, 0.25, 0.03, 0.40,"Choose slot",255,255,255,255)
		drawMenuText(0.177, 0.165, 0.25, 0.03, 0.40,"Accessories",255,255,255,255) -- row_2 (+0.037)
		drawMenuText(0.177, 0.202, 0.25, 0.03, 0.40,"Player Model",255,255,255,255) -- row_2 (+0.037)
		drawMenuText(0.177, 0.239, 0.25, 0.03, 0.40,"Exit",255,255,255,255) -- row_2 (+0.037)
	elseif cmenu.show == 2 then
		...
		drawMenuText(0.28, 0.8, 0, 0, 0.40,drawstr,255,255,255,255)
		-- debug_end
		...
		drawMenuText(0.177, 0.128, 0.25, 0.03, 0.40,"~b~Choose slot",255,255,255,255)
		drawMenuText(0.177, 0.165, 0.25, 0.03, 0.40,"Accessories",255,255,255,255) -- row_2 (+0.037)
		drawMenuText(0.177, 0.202, 0.25, 0.03, 0.40,"Player Model",255,255,255,255) -- row_2 (+0.037)
		drawMenuText(0.177, 0.239, 0.25, 0.03, 0.40,"Exit",255,255,255,255) -- row_2 (+0.037)
		---
		DrawRect(0.328,0.051,0.18,0.049,0,0,0,150) -- title
		drawMenuText(0.382,0.048,0.175,0.035, 0.40,"Choose slot",255,255,255,255)
		...
		drawMenuText(0.328,0.093,0.175,0.035, 0.40,draw_str,255,255,255,255)
		--
		if GetNumberOfPedDrawableVariations(GetPlayerPed(-1), cmenu.field-1) ~= 0 and GetNumberOfPedDrawableVariations(GetPlayerPed(-1), cmenu.field-1) ~= false then
			...
			drawMenuText(0.328,0.130,0.175,0.035, 0.40,"EMPTY SLOT",255,255,255,255)
			drawMenuText(0.328,0.167,0.175,0.035, 0.40,"EMPTY SLOT",255,255,255,255)
			drawMenuText(0.328,0.204,0.175,0.035, 0.40,"EMPTY SLOT",255,255,255,255)
			if IsControlJustPressed(1, 189) or IsDisabledControlJustPressed(1, 189) then -- left
				PlaySound(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
				if cmenu.field > 1 then 
					cmenu.field = cmenu.field-1
	...
	elseif cmenu.show == 3 then
		...
		DrawRect(0.12,0.246,0.22,0.035,0,0,0,150)
		drawMenuText(0.177, 0.128, 0.25, 0.03, 0.40,"Choose slot",255,255,255,255)
		drawMenuText(0.177, 0.165, 0.25, 0.03, 0.40,"~b~Accessories",255,255,255,255) -- row_2 (+0.037)
		drawMenuText(0.177, 0.202, 0.25, 0.03, 0.40,"Player Model",255,255,255,255) -- row_2 (+0.037)
		drawMenuText(0.177, 0.239, 0.25, 0.03, 0.40,"Exit",255,255,255,255) -- row_2 (+0.037)
		---
		DrawRect(0.328,0.051,0.18,0.049,0,0,0,150) -- title
		drawMenuText(0.382,0.048,0.175,0.035, 0.40,"Accessories",255,255,255,255)
		DrawRect(0.328,0.024,0.175,0.005,58,95,205,150)
		if cmenu.row == 1 then DrawRect(0.328,0.096,0.18,0.035,76,88,102,150) else DrawRect(0.328,0.096,0.18,0.035,0,0,0,150) end
		if cmenu.row == 2 then DrawRect(0.328,0.133,0.18,0.035,76,88,102,150) else DrawRect(0.328,0.133,0.18,0.035,0,0,0,150) end
		if cmenu.row == 3 then DrawRect(0.328,0.170,0.18,0.035,76,88,102,150) else DrawRect(0.328,0.170,0.18,0.035,0,0,0,150) end
	...
	elseif cmenu.show == 4 then
		...
		DrawRect(0.12,0.246,0.22,0.035,0,0,0,150)
		drawMenuText(0.177, 0.128, 0.25, 0.03, 0.40,"Choose slot",255,255,255,255)
		drawMenuText(0.177, 0.165, 0.25, 0.03, 0.40,"Accessories",255,255,255,255)
		drawMenuText(0.177, 0.202, 0.25, 0.03, 0.40,"~b~Player Model",255,255,255,255)
		drawMenuText(0.177, 0.239, 0.25, 0.03, 0.40,"Exit",255,255,255,255)
		DrawRect(0.328,0.051,0.18,0.049,0,0,0,150)
		drawMenuText(0.382,0.048,0.175,0.035, 0.40,"Player Model",255,255,255,255)
		DrawRect(0.328,0.024,0.175,0.005,58,95,205,150)
		if cmenu.row == 1 then DrawRect(0.328,0.096,0.18,0.035,76,88,102,150) else DrawRect(0.328,0.096,0.18,0.035,0,0,0,150) end
		if cmenu.row == 2 then DrawRect(0.328,0.133,0.18,0.035,76,88,102,150) else DrawRect(0.328,0.133,0.18,0.035,0,0,0,150) end
		if cmenu.row == 3 then DrawRect(0.328,0.170,0.18,0.035,76,88,102,150) else DrawRect(0.328,0.170,0.18,0.035,0,0,0,150) end
		...
		drawMenuText(0.328,0.093+0.037,0.175,0.035, 0.40,draw_str,255,255,255,255)
		drawMenuText(0.328,0.093+0.037*2,0.175,0.035, 0.40,"Exact Skin",255,255,255,255)
		if IsControlJustPressed(1, 189) or IsDisabledControlJustPressed(1, 189) then -- left
			if cmenu.row == 1 then
				if model_id > 1 then
					model_id=model_id-1
